...
| Networking | Virtual Network (VNet) | Resource Group | 1-80 | Case-insensitive | Alphanumeric, dash, underscore and period | `<service short name>-[section]-vnet` | `profx-vnet` |
| Networking | Subnet | Parent VNet | 2-80 | Case-insensitive | Alphanumeric, underscore, dash, and period | `<role>-subnet` | `gateway-subnet` |
| Networking | Network Interface | Resource Group | 2-64 | Case-insensitive | Alphanumeric, dash, underscore and period | `<vmname>-<num>nic` | `profx-sql1-1nic` |
| Networking | Network Security Group | Resource Group | 2-64 | Case-insensitive | Alphanumeric, dash, underscore and period | `<service short name>-<context>-nsg` | `profx-app-nsg` |
